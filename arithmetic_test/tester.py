...
class Tester:
    ...
    """Описание
            ...
            Выполняет тестрование используя заранее правильно сформатированные данные

            Параметры:
            operation_list (list): Хитровыпендренный лист из листов в формате элемент(имя функции, функция)
            Возвращает: bool, тру или фолз в завимости от правильности ответа
           """
    @staticmethod
